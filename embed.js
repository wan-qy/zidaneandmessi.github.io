...
function ua(e) {
    ...
    if (r = e.match(/FireFox\/([^\s]+)/ig)) {
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_ucweb"><i class="fa fa-globe"></i> �ٶ�������' + ' ' + r1[1]
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_qq"><i class="fa fa-weixin"></i> ΢��' + ' ' + r1[1]
        /*.split('/')[0]*/
    } else if (r = e.match(/QQBrowser\/([^\s]+)/ig)) {
        var r1 = r[0].split("/");
        outputer = '<span class="ua_qq"><i class="fa fa-globe"></i> QQ������' + ' ' + r1[1]
        /*.split('/')[0]*/
        ...
        var r1 = r[0].split("/");
        outputer = '<span class="ua_mi"><i class="fa fa-globe"></i> Miui������' + ' ' + r1[1]
        /*.split('/')[0]*/
